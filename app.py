...
def handle_message(message):
    ...
    if message != "User connected!":
        ...
        bool_list = finalResult(send)
        # print("hiiiiiiiii")
        # send(bool_list, broadcast=True)


@app.route('/')
def index():
    # bool_list = finalResult()
    print()
    # print(bool_list)
    myDict = [True, False, True, False, True]

    return render_template('index.html')


def finalResult(send):
    ...
    while True:
        ...
        space = (12-o)
        occupied = [False, False, False, False, False,
                    False, False, False, False, False,
                     False, False]
        if a1 == 1:
            cv2.polylines(frame, [np.array(area1, np.int32)], True, (0, 0, 255), 2)
            cv2.putText(frame, str('1'), (50, 441),
        ...
        if a2 == 1:
            ...
            cv2.putText(frame, str('2'), (106, 440),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[1] = True
        else:
        ...
        if a3 == 1:
            ...
            cv2.putText(frame, str('3'), (175, 436),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[2] = True
        else:
        ...
        if a4 == 1:
            ...
            cv2.putText(frame, str('4'), (250, 436),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[3] = True
        else:
        ...
        if a5 == 1:
            ...
            cv2.putText(frame, str('5'), (315, 429),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[4] = True
        else:
        ...
        if a6 == 1:
            ...
            cv2.putText(frame, str('6'), (386, 421),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[5] = True
        else:
        ...
        if a7 == 1:
            ...
            cv2.putText(frame, str('7'), (456, 414),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[6] = True
        else:
        ...
        if a8 == 1:
            ...
            cv2.putText(frame, str('8'), (527, 406),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[7] = True
        else:
        ...
        if a9 == 1:
            ...
            cv2.putText(frame, str('9'), (591, 398),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[8] = True
        else:
            ...
            cv2.putText(frame, str('9'), (591, 398),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
        if a10 == 1:
            cv2.polylines(frame, [np.array(area10, np.int32)],
                        True, (0, 0, 255), 2)
            cv2.putText(frame, str('10'), (649, 384),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[9] = True
        else:
            cv2.polylines(frame, [np.array(area10, np.int32)],
            ...
            cv2.putText(frame, str('10'), (649, 384),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
        if a11 == 1:
            cv2.polylines(frame, [np.array(area11, np.int32)],
                        True, (0, 0, 255), 2)
            cv2.putText(frame, str('11'), (697, 377),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[10] = True
        else:
            cv2.polylines(frame, [np.array(area11, np.int32)],
            ...
            cv2.putText(frame, str('11'), (697, 377),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (255, 255, 255), 1)
        if a12 == 1:
            cv2.polylines(frame, [np.array(area12, np.int32)],
                        True, (0, 0, 255), 2)
            cv2.putText(frame, str('12'), (752, 371),
                        cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1)
            occupied[11] = True
        else:
            cv2.polylines(frame, [np.array(area12, np.int32)],
